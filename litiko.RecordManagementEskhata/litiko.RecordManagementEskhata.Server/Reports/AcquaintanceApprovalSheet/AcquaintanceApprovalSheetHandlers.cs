...
namespace litiko.RecordManagementEskhata
{
  partial class AcquaintanceApprovalSheetServerHandlers
  {
    ...
    public override void BeforeExecute(Sungero.Reporting.Server.BeforeExecuteEventArgs e)
    {
      ...
      var calledFromDocument = AcquaintanceApprovalSheet.CalledFromDocument == null ? true : AcquaintanceApprovalSheet.CalledFromDocument.Value;
      ...
      foreach (var task in tasks)
      {
        ...
        foreach (var employee in acquainters)
        {
          ...
          {
            // Дата ознакомления.
            newLine.AcquaintanceDate = Sungero.Docflow.PublicFunctions.Module.ToShortDateShortTime(assignment.Completed.Value.FromUtcTime());
