...
{
  partial class ApprovalCheckingAssignmentVotinglitikoClientHandlers
  {
  ...
  partial class ApprovalCheckingAssignmentClientHandlers
  {
    ...
    public override void Showing(Sungero.Presentation.FormShowingEventArgs e)
    {
      ...
      _obj.State.Properties.Votinglitiko.IsVisible = _obj.CustomStageTypelitiko == litiko.Eskhata.ApprovalCheckingAssignment.CustomStageTypelitiko.Voting;
      _obj.State.Properties.Votinglitiko.CanAdd = false;
      _obj.State.Properties.Votinglitiko.CanDelete = false;
      _obj.State.Properties.Votinglitiko.CanCopy = false;      
    }
